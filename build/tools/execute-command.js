...
export function registerExecuteCommandTool(server) {
    ...
    server.tool("execute-command", "Execute command on connected server and get output result", {
        ...
        timeout: z
            .number()
            .optional()
            .describe("Command execution timeout in milliseconds (optional, default is 30000ms)"),
